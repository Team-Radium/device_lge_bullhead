...
# Include Radium common configuration
include vendor/radium/main.mk

# Include Radium telephony configuration
include vendor/radium/configs/telephony.mk

# Inherit AOSP device configuration for bullhead
$(call inherit-product, device/lge/bullhead/aosp_bullhead.mk)

# Override AOSP build properties
PRODUCT_NAME := radium_bullhead
